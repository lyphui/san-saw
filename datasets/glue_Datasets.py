...
def make_dj_dataset_from_csv(data_file_path=None, data_source_list=[]):
    ...
    for i, img_path in enumerate(image_path_list):
        ...
        if 1: #data_source in data_source_list:
...
class Glue_DataLoader():
    def __init__(self, args, training=True):
        ...
        val_sets = []
        val_dataset_names = []
        for ds in args.data_list:
            if ds in ['Berlin2', 'Lisbon', 'milan', 'saipan2', 'tonga']:
                # dataset = Glue
                ...
                train_set = Glue('./assets/train_1027.csv', ds,
                ...
                val_set = Glue('./assets/val_1027.csv', ds,
        ...
        if len(args.dataset) != 1:
            data_set = ConcatDataset(train_sets)

...
class ResNetMulti(nn.Module):
    def __init__(self,args, block, layers, num_classes):
        ...
        self.classifier_1 = self._make_pred_layer(Classifier_Module, 256, [2, 3, 4], [2, 3, 4], num_classes)
        self.classifier_2 = self._make_pred_layer(Classifier_Module, 512, [2, 3, 4], [2, 3, 4], num_classes)
...
def Res50_ClassINW2(args,num_classes=21, pretrained=True):
